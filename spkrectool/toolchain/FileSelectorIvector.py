...
class FileSelectorIvector:
  ...
  def projected_list(self, dir_type):
  ...
  def projected_ivector_list(self):
    """Returns the list of projected features and assures that the projected feature path is existing"""
  ...
  def whitened_ivector_list(self):
    """Returns the list of projected features and assures that the projected feature path is existing"""
  ...
  def lda_projected_ivector_list(self):
    """Returns the list of projected features and assures that the projected feature path is existing"""
  ...
  def wccn_projected_ivector_list(self):
    """Returns the list of projected features and assures that the projected feature path is existing"""
  ...
  def probe_objects_for_model(self, model_id, group):
    ...
    #return self.m_db.objects(directory=self.__probe_dir__(use_projected_ubm_dir, use_projected_ivector_dir), extension=self.m_config.default_extension, groups=group, protocol=self.m_config.protocol, purposes="probe", model_ids=(model_id,))
