...
number_of_images_per_job = 5
preprocessing_queue = {'queue':'q1d', 'hostname':'*hx5*'} #{'queue':'q1d', 'memfree':'1G'}

# number of features that one job should extract
number_of_features_per_job = 10
extraction_queue = {'queue':'q1d', 'hostname':'*hx5*'}

# number of features that one job should project
number_of_projections_per_job = 10
projection_queue = {'queue':'q1d', 'hostname':'*hx5*'}

# number of models that should be enroled by one enrol job
number_of_models_per_enrol_job = 10
enrol_queue = {'queue':'q1d', 'hostname':'*hx5*'} #{ 'queue':'q1d', 'memfree':'1G' }

# number of models that one score computation should use
number_of_models_per_score_job = 25
