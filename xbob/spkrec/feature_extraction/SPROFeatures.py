...
class SPROFeatures:
  ...
  def __call__(self, input_file, vad_file=None):
    """Read the SPRO feature file and (optionally) returns normalized cepstral features for the (optionally) given VAD file"""
   
    # Read HTK features
    cepstral_features=self.SPRORead(input_file)
